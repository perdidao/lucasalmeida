...
<body>
    ...
    <main class="center">
        ...
        <header class="main-title-wrapper">
            ...
            <a href="usuario.vbhtml" title="Cadastrar usuário" class="btn btn-azul">Novo usuário</a>
        ...
        End Code
        <ul class="usuarios">
            @for each u In svcU.ListaUsuarios(0, 200)
                @<li>

                    <div class="acoes">

                        <a href="usuario.vbhtml?id=@u.ID" title="Editar"><i class="fa fa-pencil"></i></a>

                        <a href="javascript:apagaUsuario(@u.ID);" title="Excluir"><i class="fa fa-trash-o"></i></a>
                    ...
                    <p class="modulos">@u.Modulos.Replace("<br>", ", ")</p>
